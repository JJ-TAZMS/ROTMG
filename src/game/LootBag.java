...
public class LootBag {
		...
		try {
			switch (tier) {
				...
				case "3": bagImage = ImageIO.read(new File("res/lb_pics/lb_purple.png"));
						  break;
				case "4": bagImage = ImageIO.read(new File("res/lb_pics/lb_red.png"));
					      break;
				case "5": bagImage = ImageIO.read(new File("res/lb_pics/lb_white.png"));
			      break;
	...
	public void render(Graphics g, double xIn, double yIn)
	{
		...
		g.drawImage( (Image) bagImage, (int) (Game.SCALE*(xP + Game.WIDTH/2 - Tile.TILESIZE/2)), (int) (Game.SCALE*(yP + Game.HEIGHT/2 - Tile.TILESIZE/2)), Tile.TILESIZE*Game.SCALE, Tile.TILESIZE*Game.SCALE, null);
